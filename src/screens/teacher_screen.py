...
def register_teacher(teacher_username, teacher_name, teacher_pass, teacher_pass_confirmation):
    if not teacher_username or not teacher_name or not teacher_pass:
        return False, "All Fields are required!"
    if check_teacher_exists(teacher_username):
        return False, "Username already taken"
    if teacher_pass != teacher_pass_confirmation:
...
def teacher_screen_register():
    ...
    teacher_pass = st.text_input("Enter password", type='password', placeholder='Enter password')
    teacher_pass_confirmation = st.text_input("Confirm your password", type='password', placeholder='Enter password')
    st.divider()
